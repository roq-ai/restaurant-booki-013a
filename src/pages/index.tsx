  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Tables, Manage Reservations, and Menus. A Comprehensive Solution for Restaurant Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Tables, Manage Reservations, and Menus. A Comprehensive Solution for Restaurant Management.`}
            </Text>
            <Box
